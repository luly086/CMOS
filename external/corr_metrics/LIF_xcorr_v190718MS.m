function [y,y_norm,bins,f1,f2] = LIF_xcorr_v190718MS(times1,times2,bin_size,time_window,varargin)
...
%
%   Original by Mark Humphries 6/10/07
...
y_norm = y./(sqrt(length(times1)*length(times2)));